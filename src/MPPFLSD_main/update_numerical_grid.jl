function update_numerical_grid(
    ...
    if ~elastic # simple case
        ...
        error("elastic case still needs implementation")
        ...
        vars_num.ws = vars_num.w0.*vars_sol.lams'/vars_num.C; 
        vars_num.Ds = vars_num.C*vars_num.D0.*repeat((1 ./vars_sol.lams); inner=(1, vars_num.N)); 
