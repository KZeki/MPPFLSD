...
function optim_params_to_error_calc(
    ...
    puff_params = optim_params_to_ParamsPhys(optim_params_vec; default_ParamsPhys=default_params_phys)::Union{float64,Tuple{Float64,Vector{Float64},Vector{Float64}}}
